...
function clickbtnBack(){
  let eInputAns = document.getElementById("inputAns");
  if (eInputAns.value.length > 0){
    eInputAns.value = eInputAns.value.slice(0,-1);
  }
}
window.onload = function () {
    ...
    btn0.addEventListener("click", clickbtn0, false);

    let btn1 = document.getElementById("btn1");
    btn1.addEventListener("click", clickbtn1, false);

    let btn2 = document.getElementById("btn2");
    btn2.addEventListener("click", clickbtn2, false);

    let btn3 = document.getElementById("btn3");
    btn3.addEventListener("click", clickbtn3, false);

    let btn4 = document.getElementById("btn4");
    btn4.addEventListener("click", clickbtn4, false);

    let btn5 = document.getElementById("btn5");
    btn5.addEventListener("click", clickbtn5, false);

    let btn6 = document.getElementById("btn6");
    btn6.addEventListener("click", clickbtn6, false);

    let btn7 = document.getElementById("btn7");
    btn7.addEventListener("click", clickbtn7, false);

    let btn8 = document.getElementById("btn8");
    btn8.addEventListener("click", clickbtn8, false);

    let btn9 = document.getElementById("btn9");
    btn9.addEventListener("click", clickbtn9, false);

    let btnClear = document.getElementById("btnClear");
    btnClear.addEventListener("click", clickbtnClear, false);

    let btnBack = document.getElementById("btnBack");
    btnBack.addEventListener("click", clickbtnBack, false);
};
